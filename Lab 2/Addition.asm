...
exit:	li	$v0, 4		# syscall code 4 for printing the output string
	...
	# exit error block for displaying the n is less than or equal to 0
exit_error:
	li	$v0, 4			# call syscall with code 4 to print the error string message
	la	$a0, error_string	# load the address of the error message into for output
	syscall
...
error_string:	.asciiz "The value of n must be greater than or equal to 1"